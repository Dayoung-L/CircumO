...
#' @param type indicates the type of data; N: Normal, O: Ordinal, TS: Time Series \code{"N"} (default), \code{"O"}, \code{"TS"}
...
#' @param maxlag is the maximum lag of lag correlations for computing an asymptotic covariance matrix of time series data. It defaults to 20.
#' @param SE indicates the method to compute standard errors; 1: the method to use first-order derivative, 2: the method to use second-order derivative. It defaults to 1.
